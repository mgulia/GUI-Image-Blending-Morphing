...
class Triangle:
    def __init__(self, vertices):
        ...
        #             raise ValueError("Input needs to be of type float64")
        # if np.issubdtype(vertices, np.float64) == False:
        #     raise ValueError("Input needs to be of type float64")
        ...
        if type(vertices) != np.ndarray:
            raise ValueError("Input needs to be an ndArray")
        if vertices.dtype == np.float64:
            self.vertices = vertices
        else:
            raise ValueError("Input needs to be of type float64")
        ...
        #         raise ValueError("Input needs to be of type float64")
        # self.vertices = vertices
        # if not isinstance(vertices, np.ndarry) or vertices.dtype != np.float64 or vertices.shape != (3,2):
        #     raise ValueError("Input needs to be of type float64")
    ...
    def getPoints(self):
        ...
        var1 = float(self.vertices[0, 0])
        var2 = float(self.vertices[1, 0])
        var3 = float(self.vertices[2, 0])
        car1 = float(self.vertices[0, 1])
        car2 = float(self.vertices[1, 1])
        car3 = float(self.vertices[2, 1])
...
class Morpher:
    ...
    def getImageAtAlpha(self, alpha):
        ...
        for leftTri, rightTri in zip(self.leftTriangles, self.rightTriangles):
